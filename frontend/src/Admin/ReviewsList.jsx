...
import { clearMeassage, deleteReview, fetchAdminProducts, fetchProductReviews, removeErrors, removeSuccess } from "../features/admin/adminSlice";
...
function ReviewsList() {
 ...
 const navigate=useNavigate();
  ...
  const handleDeleteReview=(productId,reviewId)=>{
    const confirm=window.confirm('Are you sure you want to delte this review?')
    if(confirm){
